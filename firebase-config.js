...
const CALENDAR_TOKEN_KEY = "family-command-center-calendar-token-v4-7-2";
const CALENDAR_SELECTED_ID_KEY = "family-command-center-calendar-selected-id-v4-7-2";
const CALENDAR_CACHE_KEY = "family-command-center-calendar-events-cache-v4-7-2";
